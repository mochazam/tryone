			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?= base_url() ?>blog/manage"><i class="icon-file-alt"></i><span class="hidden-tablet"> Blog</span></a></li>
						<li><a href="<?= base_url() ?>enquiries/inbox"><i class="icon-envelope"></i><span class="hidden-tablet"> Message</span></a></li>
