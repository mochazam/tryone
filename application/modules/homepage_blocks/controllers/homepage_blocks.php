...
class Homepage_blocks extends MX_Controller 
{
    ...
    function delete($update_id)
    {
        ...
        if ($submit == "Cancel") {
            ...
            $flash_msg = "The offer block were successfully deleted.";
    ...
    function _generate_mysql_query($update_id, $use_limit) {
        ...
        $mysql_query = "SELECT store_items.item_title,
    ...
    function create() {
        ...
        if ($submit == "Submit") {
            ...
            $this->form_validation->set_rules('block_title', 'Category title', 'required|max_length[204]');
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if (is_numeric($update_id)) {
                    ...
                    $flash_msg = "The Homepage Offer details was successfully added.";
                    $value = '<div class="alert alert-success" role="alert">'.$flash_msg.'</div>';
                    $this->session->set_flashdata('item', $value);
                    redirect('homepage_blocks/create/'.$update_id);
                }
        ...
        if (!is_numeric($update_id)) {
            $data['headline'] = "Add New Homepage Offer";
        } else {
