...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			...
			<a href="<?= base_url() ?>homepage_blocks/deleteconf/<?= $update_id ?>"><button type="button" class="btn btn-danger">Delete Offers</button></a>
		</div>
	</div>
</div>			
<?php } ?>
...
<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Offer Detail</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
						</div>
					...
					<div class="box-content">
						<?php $form_location = base_url()."homepage_blocks/create/".$update_id; ?>
						<form class="form-horizontal" method="post" action="<?= $form_location ?>">
						  <fieldset>

							<div class="control-group">
							  <label class="control-label" for="">Offer Block Title </label>
							  <div class="controls">
