...
<div class="form-actions1">
	...
	<p style="margin-top:30px">
		<a href="<?php echo base_url();?>store_items/create"><button type="button" class="btn btn-primary">Add New Item</button></a>
	</p>
</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable2">
						  ...
						  <tbody>
						  	<?php foreach ($query->result() as $row) { 
						  		$edit_item = base_url()."store_items/create/".$row->id;
						  		$status = $row->status;
							...
							<tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="<?= $edit_item ?>">
